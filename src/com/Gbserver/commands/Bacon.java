        ...
        switch(args[0]){
            ...
            case "stats":
                ...
                if(args.length == 2){
                    ...
                    //Show hit times
                    Player target;
                    if((target = Bukkit.getPlayer(args[1])) == null) {ChatWriter.writeTo(sender, ChatWriterType.ERROR, "That player cannot be found."); return true;}
                    BaconPlayer bp;
                    if((bp = BaconPlayer.getByHandle(target)) == null) {ChatWriter.writeTo(sender, ChatWriterType.ERROR, "That player is not in this game."); return true;}

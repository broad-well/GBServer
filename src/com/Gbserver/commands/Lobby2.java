...
public class Lobby2 implements CommandExecutor {
    ...
    public static class LVariables {
        ...
        public static List<Player> getAllPlayersTF() {
            List<Player> returning = new LinkedList<>();
            returning.addAll(TFInBlue);
            returning.addAll(TFInRed);
            return returning;
        }
        ...
        public static List<Player> getAllPlayersBL() {
            List<Player> returning = new LinkedList<>();
            returning.addAll(BLInBlue);
            returning.addAll(BLInRed);
            return returning;
        }
